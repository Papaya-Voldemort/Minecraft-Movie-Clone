...
window.THREE = {
    ...
    WebGLRenderer: function(options) {
        ...
        this.render = function(scene, camera) {
            ...
            this.context.fillRect(0, this.domElement.height * 0.7, this.domElement.width, this.domElement.height * 0.3);
            
            // Draw simple message
            this.context.fillStyle = 'white';
            this.context.font = '20px Arial';
            this.context.textAlign = 'center';
            this.context.fillText('Minecraft Movie Clone - 2D Fallback Mode', this.domElement.width/2, 50);
            this.context.font = '14px Arial';
            this.context.fillText('Game is running in compatibility mode', this.domElement.width/2, 80);
            this.context.fillText('3D features limited due to library constraints', this.domElement.width/2, 100);
        };
